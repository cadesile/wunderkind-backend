...
| `stages/04_interfaces/` | Routes, controllers, services, API spec, conventions | `output/routes.md` (8224b), `output/controllers.md` (21612b), `output/services.md` (10304b), `output/conventions.md` (4583b) |
