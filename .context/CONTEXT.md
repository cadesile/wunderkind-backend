...
|---|---|---|
| `stages/01_overview/` | Stack, environment, metrics, deployment | `output/stack.md` (1081b), `output/environment.md` (578b), `output/metrics.md` (126b), `output/deployment.md` (5772b) |
...
| `stages/04_interfaces/` | Routes, controllers, services, API spec, conventions | `output/routes.md` (12283b — now leads with a hand-curated client-API Auth+Description table), `output/controllers.md` (21612b), `output/services.md` (10304b), `output/conventions.md` (4583b) |
...
| `04_interfaces/conventions.md` | hand-written |
