...
class NotificationDebugController extends AbstractController
{
    ...
    private const DEBUG_TRIGGERS = [
        ...
        'ROUND_RESOLVING_SOON' => [
            'title' => '[TEST] Results incoming',
            'data'  => ['type' => 'ROUND_RESOLVING_SOON', 'competitionId' => 'debug-test', 'roundId' => 'debug-test'],
        ],
        'ADMIN_MESSAGE' => [
    ...
    #[Route('/admin/notifications/debug/trigger/{type}/{club}', name: 'admin_notification_trigger', methods: ['POST'], requirements: ['type' => 'ROUND_DRAWN|NEW_REGISTRANT|MATCH_RESULT|COMPETITION_COMPLETED|NEW_COMPETITION_OPEN|ROUND_RESOLVING_SOON|ADMIN_MESSAGE'])]
